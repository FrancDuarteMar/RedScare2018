...
@Disabled
@Autonomous(name="Rev Test One", group="Red Scare ")
public class revTestOne extends LinearOpMode  {
...
//        dumpServo = hardwareMap.get(Servo.class, "Dump Servo");
        ...
        if((pos == 1) && opModeIsActive()) {
            ...
            telemetry.addData("Successful Rotate", "driving forward" );
            telemetry.update();

            driveForward(1.5*cent);
            pRotate(.5, -85);
            driveForward(2.25*cent);
            servoSet();
