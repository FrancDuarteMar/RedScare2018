...
@TeleOp(name="2 Rev Mech TeleOp Switched ", group="A")
public class rev2CM extends OpMode {
    ...
    private int liftTop = -2600; //luke: -2428                                                                //used to be -2919
...
//        dumpServo = hardwareMap.get(Servo.class, "Dump Servo");
    ...
    public void loop() {
        ...
        if (!gamepad1.dpad_left && !gamepad1.dpad_right) {   //might use && instead of ||
            ...
            frontLeftMotor.setPower(-gamepad1.right_stick_y / speed);
            backLeftMotor.setPower(-gamepad1.right_stick_y / speed);
...
//
//        if (!gamepad2.dpad_left && !gamepad2.dpad_right) {   //might use && instead of ||
//
//            frontLeftMotor.setPower(-gamepad2.right_stick_y / speed);
//            backLeftMotor.setPower(-gamepad2.right_stick_y / speed);
//            frontRightMotor.setPower(-gamepad2.left_stick_y / speed);
//            backRightMotor.setPower(-gamepad2.left_stick_y / speed);
//
//            // ONLY ALLOWS STRAFING WHEN NOT MOVING FORWARD OR BACKWARDS //
//
...
//
//        if (drive == 0) {
//            if (gamepad2.dpad_left) { //used to be left
//                frontLeftMotor.setPower(-1 / speed); //.5
//                backLeftMotor.setPower(1 / speed); //-1 *
//                frontRightMotor.setPower(1 / speed); //*
//                backRightMotor.setPower(-1 / speed);
//
//            } else if (gamepad2.dpad_right) { //used to be right
//                frontLeftMotor.setPower(1 / speed);
//                backLeftMotor.setPower(-1 / speed);
//                frontRightMotor.setPower(1 / speed);
//                backRightMotor.setPower(-1 / speed);
...
//        // Crane MECHANISM //
//
//        if (gamepad2.dpad_up && (craneMotor.getCurrentPosition() > craneLow)) {
//            craneMotor.setPower(-1);
//
//        } else if (gamepad2.dpad_down && (craneMotor.getCurrentPosition() < craneTop )) {
//            craneMotor.setPower(1);
//
//        } else {
//            craneMotor.setPower(0);
...
//        }
        ...
        // Mineral Lift //
        if ((gamepad2.left_trigger >0 ) && (liftMotor.getCurrentPosition()< liftBottom)) {
            liftMotor.setPower(1/speed);
        } else if (gamepad2.left_bumper && (liftMotor.getCurrentPosition()> liftTop)) {
            liftMotor.setPower(-1/speed);
        } else {
