...
@Disabled
@Autonomous(name=" Robotivity Crater" , group=" B ")
public class robotivityCrater extends LinearOpMode  {
                        ...
                        if (updatedRecognitions.size() == 2) {
                            ...
                            if (goldMineralX != -1 && silverMineral1X != -1 /*&& silverMineral2X != -1*/) {
                                if (goldMineralX < silverMineral1X /*&& goldMineralX < silverMineral2X*/) {
                                    telemetry.addData("Gold Mineral Position", "Left"); //Center, -1 = 0
                                    pos = 0;
                                } else if (silverMineral2X > silverMineral1X /*&& goldMineralX > silverMineral2X*/) {
                                    telemetry.addData("Gold Mineral Position", "Right"); // Left
                                    pos = -1;
                                } else {
                                    telemetry.addData("Gold Mineral Position", "Center"); //right
                                    pos = 1;
                                }
                            }
                        }
