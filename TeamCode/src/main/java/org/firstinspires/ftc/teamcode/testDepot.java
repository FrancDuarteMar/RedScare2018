...
@Disabled
@Autonomous(name=" Rev Test Depot", group="Red Scare ")
public class testDepot extends LinearOpMode  {
...
//        dumpServo = hardwareMap.get(Servo.class, "Dump Servo");
        ...
        lift();
        driveForward(10);
        telemetry.addData("Vision is Initializing", "Finished positioning");
        telemetry.update();

        resetGyro();
        telemetry.addData("Resetting Gyro", "Vision will commence");
        telemetry.update();
        ...
        telemetry.addData("Vision Successful!",pos);
        telemetry.update();

//        resetGyro();
//        telemetry.addData("Gyro Reset, moving towards: ", pos);
//
        ...
        // CENTER //
        //working for center, center position = 0
