...
@Disabled
@TeleOp(name="Rev Mech TeleOp Switched ", group="A")
public class revMechSwitched extends OpMode {
    ...
    public void loop() {
        ...
        if (drive == 0) {
            if (gamepad1.dpad_left) { //used to be left
                ...
                frontLeftMotor.setPower(.45 / speed);
                backLeftMotor.setPower(-1 / speed);
                frontRightMotor.setPower(-.45 / speed);
                backRightMotor.setPower(1                            / speed);
