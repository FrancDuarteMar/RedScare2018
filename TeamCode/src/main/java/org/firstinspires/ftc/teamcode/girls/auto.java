...
@Disabled
@Autonomous(name = "F-MechanicatsAuto", group = "Mechanicats")
public class auto extends LinearOpMode {
    ...
    private int elementDriveDistance = 50;
    private int elementDriveDistanceLong = 50;
    private int elementSecondDistance = 130;
    private int elementThirdDistance = 125;
    private int craterParkDistance = 160;
    private double CatOutAngle = 1;
    private double CatInAngle = 0.5;
...
//        waitForStart();
    ...
    public void landRobot() {
        ...
        //DROP CODE FOR AUTO //
//
//        while ((lift.getCurrentPosition()< liftTop) && opModeIsActive()){
//            lift.setPower(-1);
//        }
//        lift.setPower(0);
    }
...
//        lift.setPower(0);
    ...
    public void sampleElement() {
        ...
        telemetry.addData(">", "Sampling gold...");
        telemetry.update();
    ...
    public void sampleElementD (){ // position 1 = left, 2 = middle, 3 = right
        // find position, turn to position, go to position
        int GoldPosition;
    ...
    public void ScenarioInFrontOfDepot() {
        ...
        if (GoldPosition == 2){
            ...
            // going to crater
            turnAnlgeGyro(90,.7);
            driveBackward(85,.7);//Needs to be 42"
            turnAnlgeGyro(-137,.7);
            driveForward(20,.7);//Needs to be 19"
        }
        else if (GoldPosition == 1){
            driveBackward(40,.7);//needs to be 40"
            turnHeadingGyro(-45,.7);
            driveBackward(10,.7);
            tokenBox.setPosition(CatOutAngle);
            sleep(500);
            tokenBox.setPosition(CatInAngle);
